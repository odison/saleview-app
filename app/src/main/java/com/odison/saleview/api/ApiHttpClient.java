package com.odison.saleview.api;
...
//     public final static String HOST = "192.168.199.234";
//     private static String API_URL = "http://192.168.199.234:9090/AppServer/%s";
     public final static String HOST = "120.27.132.25";
     //private static String API_URL = "http://pt.fuo2.com:9090/AppServer/%s";
    private static String API_URL = "http://cs.fuo2.com/merchant.php?g=Merchant&%s";
    ...
    public static void get(String partUrl, JsonHttpResponseHandler handler){
        client.get(getAbsoluteApiUrl(partUrl), handler);
        log(new StringBuilder("GET ").append(partUrl).toString());
    }
