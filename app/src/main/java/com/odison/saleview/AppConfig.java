...
public class AppConfig {
    ...
    //地图展示时候的定位时间间隔
    public final static Integer APP_LOCATION_INTERVAL = 1000* 10;

    public final static String APP_NAME = "com.odison.saleview";
    ...
    public static final String APP_FILE_PATH_NAME = "FUYANG";
